...
export type PropertyFilter = IntegerPropertyFilter | IntegerArrayPropertyFilter | TextPropertyFilter | TextArrayPropertyFilter | BooleanPropertyFilter | BooleanArrayPropertyFilter | DatePropertyFilter | DateArrayPropertyFilter | GeoPropertyFilter | IsNullPropertyFilter | UnknownPropertyFilter;
...
export type PropertyAggregation = IntegerPropertyAggregation | TextPropertyAggregation | BooleanPropertyAggregation | DatePropertyAggregation;
...
export declare enum NumericMetrics {
    Count = "COUNT",
    Maximum = "MAXIMUM",
    Mean = "MEAN",
    Median = "MEDIAN",
...
export declare enum TextMetrics {
    Count = "COUNT",
    Type = "TYPE",
    TopOccurrences = "TOP_OCCURRENCES"
}
export declare enum BooleanMetrics {
    Count = "COUNT",
    Type = "TYPE",
...
export declare enum DateMetrics {
    Count = "COUNT",
    Maximum = "MAXIMUM",
    Median = "MEDIAN",
    Minimum = "MINIMUM",
